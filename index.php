...
<html>
	<head>
		...
		<title>Naples • Pizza • Pasta • Calzones</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://cosmospizzanaples.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Lunch Menu</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Dinner Menu</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Takeout & Catering</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Gallery</a></div>
              </div>              
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
            ...
            <p>Located in the heart of Naples just a half mile north of 5th Avenue South, Cosmos Italian Cafe and Pizzeria offers the finest in authentic and inspired Italian cuisine. Using only the freshest ingredients, our menu features fresh homemade pastas, specialty pizzas, seafood, sandwiches and more! Introducing his family’s generations-old recipes and the experience of his career, owner Gianluca Corso has given Cosmos Italian Cafe and Pizzeria that unique, intimate and irresistible Italian flare that you’ll find nowhere else. 
            So be sure to stop by, sample our delectable dishes, and MANGIA!</p>
			<h2>Dine In & Take Out:</h2>
			<p>Monday - Friday 11am - Close</p> 
			<p>Saturday & Sunday 4pm - Close</p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Takeout & Catering</a></li>
